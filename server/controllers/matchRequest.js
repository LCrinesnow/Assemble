...
module.exports = async ctx => {
  ...
  await qcloud.mysql("Team-Members").insert(matchRequest)

  // if (ctx.query.activityName === 'Basketball')
  //   await qcloud.mysql("Team-Member-Basketball").insert(matchRequest)
  // if (ctx.query.activityName === 'Boardgame')
  //   await qcloud.mysql("Team-Member-Boardgame").insert(matchRequest)
    
  // await qcloud.mysql("Basketball-Location-SpareTime").del().where({ 6 })
